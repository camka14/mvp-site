...
export const buildCodexAffiliateCoverageObjective = (
  ...
  return [
    ...
    'with fresh results, and continue until COVERED or WAITING_FOR_PIPELINE. Mark COVERED',
    'only with two independent source families, completed',
    'query profiles, zero unresolved automatically promotable direct leads, and recorded',
    'recent new-domain yields. Review-only intermediary leads do not block coverage.',
