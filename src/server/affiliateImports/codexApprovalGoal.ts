...
export const buildCodexAffiliateApprovalObjective = (
  ...
  return [
    ...
    'sport. Missing paths or scrape rows are PACKAGE_VALIDATION_FAILED; candidate-count',
    'conflicts are DUPLICATE_SAFETY_INVALID. Return both to the producer. DEFER only',
    'genuinely inaccessible or conflicting evidence.',
