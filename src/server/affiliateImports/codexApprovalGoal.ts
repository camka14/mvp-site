...
export const buildCodexAffiliateApprovalObjective = (
  ...
  return [
    ...
    'Independently verify event and organization description quality against stored',
    'first-party evidence. Descriptions must describe the activity or organization in',
    'natural language, not where it was listed, found, scraped, or mapped. Event copy',
    'must not start by repeating the full title. A natural organization-level fallback',
    'may be shared when the site has no event-specific prose. Set',
    'descriptionQualityVerified=true only after this check. REJECT concrete defects',
    'with EVENT_DESCRIPTION_INVALID or ORGANIZATION_DESCRIPTION_INVALID and return them',
    'to PRODUCER_REPAIR.',
