...
export const buildCodexAffiliateApprovalObjective = (
  ...
  return [
    ...
    'If no mark exists, do not reject an otherwise-valid package; set',
    'officialLogoVerified=false and logoAbsenceAccepted=true.',
    ...
    'missing fallback data as ORGANIZATION_LOCATION_INVALID producer repair. Use human',
    'review only for conflicting locality evidence. Missing',
    'event locations do not invalidate a valid organization when excluded and logged.',
    ...
    'one division with all canonical fields; repair missing or ambiguous data.',
    'Independently verify event and organization description quality from first-party',
    'evidence; copy must describe the activity, not discovery, and must not repeat its title.',
    'Set descriptionQualityVerified=true only after checking. Return',
    ...
    `output/affiliate-codex-approvals/progress/${reviewerId}.jsonl current and finish with a compact`,
