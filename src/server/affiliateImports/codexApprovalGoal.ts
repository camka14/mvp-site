...
export const buildCodexAffiliateApprovalObjective = (
  ...
  return [
    ...
    'one division with a source name and all canonical fields. Reject missing or incomplete',
    'divisions as producer repair. Never cross event boundaries or guess ambiguity.',
    ...
    'Set descriptionQualityVerified=true only after checking. Return concrete',
