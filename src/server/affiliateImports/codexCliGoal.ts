...
export const buildCodexAffiliateIngestionObjective = (
  ...
  return [
    ...
    'The live flag authorizes intake reads, governed URL/capture writes, and queue',
    'transitions, never organization, source, mapping, candidate, or publication writes.',
