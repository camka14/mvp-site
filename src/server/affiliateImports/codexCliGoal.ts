...
export const buildCodexAffiliateIngestionObjective = (
  ...
  return [
    ...
    'Create a review-ready organization setup, EVENT/RENTAL/CLUB mapping, official',
    'URLs and logo disposition, provenance, fixtures, tests, two duplicate-safe review',
    'scrapes, result artifact, and source-scoped commit.',
    ...
    'event identity/detail-page context; never merge divisions across cards,',
    'dates, venues, or registration pages. Preserve the exact source division label',
    'as the display name, then select canonical gender M/F/C, ratingType',
    ...
    'age or skill instead of guessing. Every accepted EVENT must have',
    'a source-supported division with every canonical field. Exclude and log an event',
    'when evidence cannot support it; never submit a divisionless event. Keep price and capacity',
