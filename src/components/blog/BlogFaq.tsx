...
export default function BlogFaq({ items }: { items: BlogFaqItem[] }) {
  return (
    <section className="landing-surface-strong marketing-faq rounded-3xl p-6 sm:p-8">
      <h2 className="landing-section-title text-2xl font-semibold sm:text-3xl">FAQs</h2>
      <div className="mt-6 space-y-4">
        {items.map((item) => (
          <article key={item.question} className="marketing-faq-item rounded-2xl px-5 py-4">
