...
import { approveOwnershipTransferByCurrentOwner } from '@/server/organizationClaims/service';
...
export async function POST(
  ...
  try {
    ...
    const claim = await approveOwnershipTransferByCurrentOwner(id, requestId, session);
