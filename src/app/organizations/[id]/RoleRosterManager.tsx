                ...
                {inviteMode === 'existing' ? (
                  <Stack gap="sm">
                    <MultiSelect
                      ...
                      onChange={(values) => {
                        const nextTypes = values.filter((value): value is StaffMemberType => (
                          STAFF_TYPE_OPTIONS.some((option) => option.value === value)
                        ));
                        if (!nextTypes.length) {
                          return;
                        }
                        ...
                        {searchResults.map((result) => (
                          <Paper key={result.$id} withBorder p="sm" radius="md">
                            <Group justify="space-between" align="center" gap="sm">
                              ...
                              <Button
                                size="xs"
                                onClick={() => onAddExisting(result, existingInviteTypes)}
                              >
                                Invite
                              </Button>
                            </Group>
            ...
            <Paper withBorder p="md" radius="md">
              <Stack gap="sm">
                ...
                <MultiSelect
                  ...
                  onChange={(values) => {
                    setTypeFilter(
                      values.filter((value): value is StaffMemberType => (
                        STAFF_TYPE_OPTIONS.some((option) => option.value === value)
                      )),
                    );
                  }}
