...
Open the club organization, then go to the `Customers` tab. If the club is still getting its teams and parent context organized, start with [How Clubs Can Manage Players, Parents, Teams, and Events](/guides/club-players-parents-teams), then return to this communication workflow.

The customer view helps staff understand whether an update is going to a player, parent, guardian, team manager, payer, or team record.

![BracketIQ Customers tab showing player, parent, team, billing, event, and document context](/blog/club-communication/01-customers-parents-context.png)
