...
The example uses a one-day indoor soccer tournament, but the same management workflow applies to volleyball, outdoor soccer, basketball, pickleball, tennis, hockey, baseball, football, and other recreational sports.
...
## Check the schedule by time and field

Open Schedule after the team list looks right. Switch to the day view when you want to inspect the tournament flow across fields or courts.

![Schedule tab showing BracketIQ tournament matches by field and time](/blog/manage-tournament/03-schedule-tab.png)
...
- Open Schedule and inspect the day by time and field.
