...
const buildUpcomingRentalSlotWindow = () => {
...
const upcomingRentalSlotWindow = buildUpcomingRentalSlotWindow();
...
export const SEED_RENTAL_SLOT = {
  ...
  price: 2500,
  repeating: false,
  dayOfWeek: upcomingRentalSlotWindow.dayOfWeek,
  startDate: upcomingRentalSlotWindow.startDate,
  endDate: upcomingRentalSlotWindow.endDate,
