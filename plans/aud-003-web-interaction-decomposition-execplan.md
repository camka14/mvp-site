...
- [x] (2026-07-15 07:24Z) Milestone 5h: moved create-form official/location reference hydration and rental, open-ended schedule, team-signup, roster, and creator-participation invariants into focused 103-line and 106-line hooks. Seven direct regressions and the complete 15-suite/186-test serial EventForm gate pass; TypeScript is clean, focused ESLint has zero errors, and diff checks pass.
