...
The Troutdale Indoor Sports event/program sources are saved locally as three page-level mappings: `troutdale-indoor-sports-adult-soccer-leagues` with active mapping `bfb292e9-6474-4cf0-9a12-6e54232a9951` and run `6f966d98-fb36-46f6-b7ef-9344a4a1517a`; `troutdale-indoor-sports-youth-soccer-league` with active mapping `57bc7f43-ef0d-4c59-a429-200fcf3319e1` and run `d7b35d7c-34e2-48f1-8d72-1cf17c0d1fce`; and `troutdale-indoor-sports-mens-basketball-league` with active mapping `8d5334b8-3bae-4d59-992b-e59355cfc294` and run `03aa3588-4f2c-43ad-a284-7ba2cde4df93`. Each run persisted one affiliate event candidate. These are intentionally modeled as conservative league/program listings with official page CTAs and "confirm current session" status text because the source pages do not expose clean repeated current session rows.
