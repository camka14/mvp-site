...
- [ ] Build the deterministic mapping generator, isolated job worktree runner, and evaluation harness without connecting a model. (2026-07-29 19:43Z: constrained byte-stable generation, syntax validation, fixture model client, frozen evaluation scorecard, hash-verified evidence toolbox, and detached-worktree runner are complete; named focused-test execution and disposable-database scrape validation remain.)
