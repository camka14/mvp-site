...
- [ ] Build the deterministic mapping generator, isolated job worktree runner, and evaluation harness without connecting a model. (2026-07-29 19:39Z: constrained byte-stable generation, syntax validation, fixture model client, and frozen evaluation scorecard are complete; isolated worktree execution and disposable-database scrape validation remain.)
