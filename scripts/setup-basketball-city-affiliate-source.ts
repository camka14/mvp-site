/** Local-only setup for the Basketball City stored-intake club and rental package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Basketball City', location: 'New York, NY', address: null, description: BASKETBALL_CITY_DESCRIPTION, logoId, ownerId: owner.id, website: BASKETBALL_CITY_HOME_URL, sports: ['Basketball'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
