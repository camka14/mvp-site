/** Local-only setup for the Globall Competitions stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Globall Competitions', location: 'New York region', address: null, description: GLOBALL_COMPETITIONS_ORG_DESCRIPTION, logoId: null, ownerId: owner.id, website: GLOBALL_COMPETITIONS_HOME_URL, sports: ['Soccer'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
