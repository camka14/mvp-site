/** Local-only setup for the Sofive Chitown stored-intake package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: ORGANIZATION_NAME, location: 'Chicago, IL', address: '2343 S Throop St, Chicago, IL 60608', description: SOFIVE_CHITOWN_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: SOFIVE_CHITOWN_HOME_URL, sports: ['Soccer'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
