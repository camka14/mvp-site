/** Local-only setup for the Long Island Volleyball Association stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Long Island Volleyball Association', location: 'Long Island, NY', address: null, description: LONG_ISLAND_VOLLEYBALL_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: LONG_ISLAND_VOLLEYBALL_HOME_URL, sports: ['Volleyball'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
