/** Local-only setup for the Downtown United Soccer Club stored-intake club package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Downtown United Soccer Club', location: 'New York, NY', address: null, description: DUSC_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: DUSC_HOME_URL, sports: ['Soccer'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
