/** Local-only setup for the Northwell Health Ice Center stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Northwell Health Ice Center', location: 'Long Island, NY', address: null, description: NORTHWELL_ICE_CENTER_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: NORTHWELL_ICE_CENTER_HOME_URL, sports: ['Ice Hockey'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
