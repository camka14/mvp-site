/** Operator-approved setup for the NYC VolleyVerse stored-intake club package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'NYC VolleyVerse', location: 'New York, NY', address: null, description: NYC_VOLLEYVERSE_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: NYC_VOLLEYVERSE_HOME_URL, sports: ['Volleyball'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
