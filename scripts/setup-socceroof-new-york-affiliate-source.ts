/** Operator-approved setup for the Socceroof New York stored-intake package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Socceroof New York', location: 'New York', address: null, description: SOCCEROOF_NEW_YORK_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: SOCCEROOF_NEW_YORK_HOME_URL, sports: ['Soccer'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
