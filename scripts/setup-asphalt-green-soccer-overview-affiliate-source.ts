/** Local-only setup for the Asphalt Green soccer overview stored-intake package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Asphalt Green Soccer Club', location: 'New York, NY', address: null, description: ASPHALT_GREEN_AGSC_DESCRIPTION, logoId, ownerId: owner.id, website: ASPHALT_GREEN_HOME_URL, sports: ['Soccer'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
