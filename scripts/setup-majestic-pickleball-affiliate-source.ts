/** Operator-approved setup for the Majestic Pickleball stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Majestic Pickleball', location: null, address: null, description: MAJESTIC_PICKLEBALL_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: MAJESTIC_PICKLEBALL_HOME_URL, sports: ['Pickleball'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
