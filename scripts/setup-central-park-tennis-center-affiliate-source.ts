/** Local-only setup for the Central Park Tennis Center stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Central Park Tennis Center', location: 'New York City, NY', address: null, description: CENTRAL_PARK_TENNIS_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: CENTRAL_PARK_TENNIS_HOME_URL, sports: ['Tennis'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
