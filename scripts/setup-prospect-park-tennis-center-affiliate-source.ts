/** Operator-approved setup for the Prospect Park Tennis Center stored-intake rental package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Prospect Park Tennis Center', location: 'Brooklyn, NY', address: null, description: PROSPECT_PARK_TENNIS_CENTER_ORG_DESCRIPTION, logoId: null, ownerId: owner.id, website: PROSPECT_PARK_TENNIS_CENTER_URL, sports: ['Tennis'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
