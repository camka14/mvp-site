/** Local-only setup for the Never Too Late Basketball stored-intake package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Never Too Late Basketball', location: 'New York City, NY', address: null, description: NEVER_TOO_LATE_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: NEVER_TOO_LATE_HOME_URL, sports: ['Basketball'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
