/** Local-only setup for the Brookhaven youth baseball stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Town of Brookhaven Youth Baseball Program', location: 'Brookhaven, NY', address: null, description: BROOKHAVEN_BASEBALL_ORG_DESCRIPTION, logoId: null, ownerId: owner.id, website: BROOKHAVEN_BASEBALL_URL, sports: ['Baseball'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
