/** Operator-approved setup for the Cunningham Tennis stored-intake club and rental package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Cunningham Tennis', location: 'New York, NY', address: null, description: CUNNINGHAM_DESCRIPTION, logoId, ownerId: owner.id, website: CUNNINGHAM_HOME_URL, sports: ['Tennis'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
