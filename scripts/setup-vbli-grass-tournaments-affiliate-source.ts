/** Operator-approved setup for the VBLI stored-intake tournament package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'VBLI', location: null, address: null, description: VBLI_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: VBLI_HOME_URL, sports: ['Volleyball'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
