/** Operator-approved setup for the Island Fastpitch stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Island Fastpitch', location: null, address: null, description: ISLAND_FASTPITCH_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: ISLAND_FASTPITCH_HOME_URL, sports: ['Softball'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
