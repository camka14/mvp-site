/** Operator-approved setup for the Atlantic Volleyball Academy stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Atlantic Volleyball Academy', location: 'Long Island, NY', address: null, description: ATLANTIC_VOLLEYBALL_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: ATLANTIC_VOLLEYBALL_HOME_URL, sports: ['Volleyball'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
