/** Local-only setup for The NYC Volleyball Club stored-intake club package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'The NYC Volleyball Club', location: 'Bronx, NY', address: null, description: THE_NYC_VOLLEYBALL_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: THE_NYC_VOLLEYBALL_HOME_URL, sports: ['Volleyball'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
