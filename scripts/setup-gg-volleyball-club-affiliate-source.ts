/** Operator-approved setup for the G&G Volleyball Club stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'G&G Volleyball Club', location: 'Brooklyn, NY', address: '1625 Ocean Ave, Brooklyn, NY 11230', description: GG_VOLLEYBALL_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: GG_VOLLEYBALL_TRYOUTS_URL, sports: ['Volleyball'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
