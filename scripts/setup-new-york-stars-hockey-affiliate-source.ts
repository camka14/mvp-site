/** Local-only setup for the New York Stars Hockey stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'New York Stars Hockey', location: 'Brooklyn, NY', address: null, description: NEW_YORK_STARS_HOCKEY_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: NEW_YORK_STARS_HOCKEY_HOME_URL, sports: ['Ice Hockey'], status: 'UNLISTED', publicPageEnabled: false, publicWidgetsEnabled: false };
