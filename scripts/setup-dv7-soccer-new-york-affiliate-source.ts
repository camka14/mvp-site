/** Operator-approved setup for the DV7 Soccer Academy New York stored-intake CLUB package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'DV7 Soccer Academy New York', location: 'New York, NY', address: null, description: DV7_SOCCER_NEW_YORK_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: DV7_SOCCER_NEW_YORK_HOME_URL, sports: ['Soccer'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
