/** Operator-approved setup for the Soccer Friends USA stored-intake club package. */
...
const main = async () => {
  ...
  try {
    ...
    const organization = { updatedAt: new Date(), name: 'Soccer Friends USA', location: 'Queens, NY', address: null, description: SOCCER_FRIENDS_USA_ORG_DESCRIPTION, logoId, ownerId: owner.id, website: SOCCER_FRIENDS_USA_HOME_URL, sports: ['Soccer'], status: 'UNLISTED' as const, publicPageEnabled: false, publicWidgetsEnabled: false };
